        ...
        private void OnAssetRequested(object? sender, AssetRequestedEventArgs e)
        {
            ...
            else if (e.NameWithoutLocale.IsEquivalentTo("Data/Quests"))
            {
                e.Edit(editor =>
                {
                    ...
                    data[GrowMysticTreeQuest] = L("Basic/Plant The Mystic Seed/Linus gave you some tree seeds...  Do the Junimos talk to him too?/Grow a Mystic Tree and 2 Mahogony Trees to adulthood on your farm./null/-1/0/-1/false");
                    data[MeetLinusQuestKey] = L("Basic/Meet Linus In The Secret Woods/Have dinner with Linus in the Secret Woods/Enter the secret woods on a sunny day between 6 and 11pm./null/-1/0/-1/false");
                });
            }
