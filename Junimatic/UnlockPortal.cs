        ...
        private void OnAssetRequested(object? sender, AssetRequestedEventArgs e)
        {
            ...
            else if (e.NameWithoutLocale.IsEquivalentTo("Data/Quests"))
            {
                e.Edit(editor =>
                {
                    ...
                    data[OldJunimoPortalQuest] = "Basic/The Strange Little Structure/I found the remnants of what looks like a little building.  It smells like it has some Forest Magic in it./Bring the remnants of the strange little structure to the wizard./null/-1/0/-1/false";
                });
            }
        }
